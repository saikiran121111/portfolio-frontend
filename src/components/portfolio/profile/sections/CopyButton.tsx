...
export default function CopyButton({ text, label }: { text: string; label: string }) {
  ...
  return (
    <motion.button
      onClick={handleCopy}
      className="ml-2 relative inline-flex items-center justify-center w-8 h-8 rounded-lg bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/30 text-white/60 hover:text-white transition-all duration-200 group"
